...
OnlineMag theme is translation ready.
...
5) https://pixabay.com/en/usa-new-york-brooklyn-bridge-2759096/
...
onlinemag includes support for Infinite Scroll in Jetpack.
...
* Added onlinemag full width page template.
* Some other minor fixing.

= - 1.1.2 - =
* issue fixing on blog section

= - 1.1.1 - =
* Get all category post in slider section
* Get all category post in  blog section
* Get slider and blog section in latest blog 
* Some other minor fixing.
...
= - 1.0.3 - =
* Design related to archive page fixed.
