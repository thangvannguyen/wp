...
$onlinemag_customizer_defaults['onlinemag-featured-slider-category'] = 0;
...
$onlinemag_customizer_defaults['onlinemag-slider-enable-blog'] = 1;
...
// /*for blog option */
$onlinemag_settings_controls['onlinemag-slider-enable-blog'] = array(
    'setting' => array(
        'default'          =>  $onlinemag_customizer_defaults['onlinemag-slider-enable-blog']  
    ),
    'control' => array(
        'label'             => esc_html__('Enable Slider on Blog Archive','onlinemag'),
        'section'           => 'onlinemag-feature-section-options',
        'type'              => 'checkbox',
        'priority'          => 80,
        'acticve_callback'  => ''
