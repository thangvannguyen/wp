                ...
                <div class="sec-menu">
                    ...
                    <?php
                        wp_nav_menu( array(
                            ...
                            'fallback_cb'    => 'onlinemag_primary_menu_mobile_callback'
 ...
 */
    function onlinemag_main_slider_setion(){
        ...
        if (  is_front_page() && is_home() ) {
            ...
            if( 1 == $onlinemag_customizer_all_values['onlinemag-slider-enable-blog'] ){

                do_action('onlinemag_action_front_page_slider');
            }
            if( 1 == $onlinemag_customizer_all_values['onlinemag-blog-enable-blog'] ){
                do_action('onlinemag_action_front_page_blog');
            }

            // onlinemag_action_front_page_slider
        } else {
            /**
